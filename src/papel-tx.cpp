...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Papel Core papel-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  papel-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dash transaction") + "\n" +
              "  papel-tx [options] -create [commands]   " + _("Create hex-encoded dash transaction") + "\n" +
              "\n";
