    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Papel Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Papel address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Papel: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Papel Core"), this);
    aboutAction->setStatusTip(tr("Show information about Papel Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Papel Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Papel addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Papel addresses"));
    ...
    openAction->setStatusTip(tr("Open a Papel: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Papel Core help message to get a list with possible Papel Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Papel Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Papel network", "", count));
    } else {
...
{
    QString strTitle = tr("Papel Core"); // default title
