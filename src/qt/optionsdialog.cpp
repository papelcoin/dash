    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PAPEL-light"), QVariant("light"));
//    ui->theme->addItem(QString("PAPEL-light-hires"), QVariant("light-hires"));
//    ui->theme->addItem(QString("PAPEL-blue"), QVariant("drkblue"));
//    ui->theme->addItem(QString("PAPEL-Crownium"), QVariant("crownium"));
//    ui->theme->addItem(QString("PAPEL-traditional"), QVariant("trad"));
